...
sim_duration = st.sidebar.slider("Simulation Duration (seconds)", 100, 2000, 1000)
...
with col1:
    ...
    if st.button("🏁 Run Comparative Simulation"):
        ...
        proc2 = subprocess.Popen(["python", "baseline.py"]) [cite: 1]
...
m1.metric("CO2 Saved", "12.4 kg", "-15%")
m2.metric("Avg. Wait Time", "18s", "-30%")
m3.metric("Fuel Efficiency", "+12%", "Green")